...
>
> **Son güncelleme:** 2026-05-16 (Faz 1.1 — PRD-MVP scope locking ✅ shipped; pytest 476 → 496, zero regression)
...
| # | İş | Kaynak | Efor | Bağımlılık | Durum |
|---|---|---|---|---|---|
| 2.1 | Docker skills (node/python/compose) | §2 | ~5h | 1.5 (skill pattern) | ⬜ todo |
| 2.2 | Local LLM provider (Ollama/LM Studio) | §3 | ~7h | — | ⬜ todo |
| 2.3 | Reviewer mutation testing | §6 P1-7 | ~6h | 1.5 | ⬜ todo |
| 2.4 | Skill yazma rehberi + 2-3 community skill | §5 dok | ~4h | 2.1 | ⬜ todo |
