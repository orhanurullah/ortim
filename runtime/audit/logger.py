...
Compliance posture (M1 — Gun 0):
  ...
  * Each event carries a `prev_hash` field that chains to the previous event,
    enabling tamper-evidence detection via `runtime.audit.verify.verify_chain`.
...
from runtime.audit.redact import redact_value, redaction_enabled
from runtime.audit.verify import GENESIS_HASH, event_hash
